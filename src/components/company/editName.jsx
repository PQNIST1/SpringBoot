...
import { updateName, resetSuccess } from '../../controller/SliceReducer/company';

const EditName = ({ id, compannyName }) => {
        ...
        <>
            ...
            {showSuccess && (
                <div className="fixed top-0 right-0 flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow-lg animate-slide-in-right" role="alert">
                    ...
                    <div className="ms-3 text-sm font-normal">Name update successfully!</div>
            ...
            {showError && (
                <div className="fixed top-0 right-0  flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow-lg animate-slide-in-right" role="alert">
                    ...
                    <div className="ms-3 text-sm font-normal">Failed to update name. Please try again!</div>
...
EditName.propTypes = {
    ...
    compannyName: PropTypes.string.isRequired,
};
