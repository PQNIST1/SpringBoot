...
import { createCompany, getCompanyUser } from '../../controller/SliceReducer/company';
        ...
        <>
            ...
            {showSuccess && users && (
                <div className="fixed top-0 right-0 flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow-lg animate-slide-in-right" role="alert">
                    ...
                    <div className="ms-3 text-sm font-normal">Company add successfully!</div>
            ...
            {showError && users && (
                <div className="fixed top-0 right-0  flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow-lg animate-slide-in-right" role="alert">
                    ...
                    <div className="ms-3 text-sm font-normal">Failed to add company. Please try again!</div>
